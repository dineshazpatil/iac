...
# You can use spaces in variables but then you must enclosed the variable in {}

${My Variable} = "Test"


$phrase  = "Hi`tthis`ais tab  "
...
$Global:testnewscope = "Test new scope"
...
#To actually display the variable name instead of it's value, escape it with a backtick
"There are `$items items are in the folder `$loc."

# This works only with double quotes.
'There are $items items are in the folder $loc.'

# String Interpolcation works with here strings
...
#We can use expressions in strings , need to wrap in $()
Clear-Host
...
"The Addition of a 30 and 40 is $(30 + 40)."
